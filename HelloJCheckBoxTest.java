...
public class HelloJCheckBoxTest extends JFrame implements ActionListener{
	private JLabel lbl;
//	private JLabel lbl1;
//	private JLabel lbl2;
	...
	public static void main(String[] args){
		HelloJCheckBoxTest hcbt = new HelloJCheckBoxTest("CheckBox!");
		hcbt.setVisible(true);
	}
...
//		}
	...
	HelloJCheckBoxTest(String title){
		setTitle(title);
		setSize(300,200);
		setLocation(0,0);
